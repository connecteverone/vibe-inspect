...
class RustdeskBridge {
  ...
  late final void Function(int) _setDirectOnly;
  late final int Function(Pointer<Utf8>, Pointer<Utf8>, Pointer<Utf8>) _sessionAdd;
  ...
  void ensureLoaded() {
    ...
    _lib = _openLibrary();
    _setDirectOnly = _lib.lookupFunction<Void Function(Int32), void Function(int)>(
      'rustdesk_set_direct_only',
    );
    _mainInit = _lib.lookupFunction<
        Int32 Function(Pointer<Utf8>, Pointer<Utf8>),
        int Function(Pointer<Utf8>, Pointer<Utf8>)>('rustdesk_main_init');
    _sessionAdd = _lib.lookupFunction<
    ...
    _sessionStartNoUi = _lib.lookupFunction<Int32 Function(Pointer<Utf8>),
        int Function(Pointer<Utf8>)>('rustdesk_session_start_no_ui');
    _sessionClose = _lib.lookupFunction<Void Function(Pointer<Utf8>),
        void Function(Pointer<Utf8>)>('rustdesk_session_close');
    _quicConnect = _lib.lookupFunction<
        Int32 Function(
          Pointer<Utf8>,
          Uint16,
          Pointer<Utf8>,
    ...
    _sessionGetDisplaySize = _lib.lookupFunction<
        Int32 Function(Pointer<Utf8>, IntPtr, Pointer<Uint32>, Pointer<Uint32>),
        int Function(Pointer<Utf8>, int, Pointer<Uint32>, Pointer<Uint32>)>(
      'rustdesk_session_get_display_size',
    );
    _sessionSetSize = _lib.lookupFunction<
        Void Function(Pointer<Utf8>, IntPtr, Uint32, Uint32),
        void Function(Pointer<Utf8>, int, int, int)>(
      'rustdesk_session_set_size',
    );
    _sessionGetRgbaSize = _lib.lookupFunction<IntPtr Function(Pointer<Utf8>, IntPtr),
        int Function(Pointer<Utf8>, int)>('rustdesk_session_get_rgba_size');
    _sessionGetRgba = _lib.lookupFunction<
        Pointer<Uint8> Function(Pointer<Utf8>, IntPtr),
        Pointer<Uint8> Function(Pointer<Utf8>, int)>('session_get_rgba');
    _sessionNextRgba = _lib.lookupFunction<Void Function(Pointer<Utf8>, IntPtr),
        void Function(Pointer<Utf8>, int)>('rustdesk_session_next_rgba');
    ...
    _sessionLogin = _lib.lookupFunction<
        Int32 Function(Pointer<Utf8>, Pointer<Utf8>),
        int Function(Pointer<Utf8>, Pointer<Utf8>)>('rustdesk_session_login');
    _sessionBootstrap = _lib.lookupFunction<
  ...
  void ensureInitialized() {
    ...
    try {
      _setDirectOnly(kDirectOnly ? 1 : 0);
  ...
  Size? getDisplaySize(String sessionId, int display) {
    ...
    try {
      final result = _sessionGetDisplaySize(sessionPtr, display, widthPtr, heightPtr);
      if (result != 0) {
        return null;
      }
